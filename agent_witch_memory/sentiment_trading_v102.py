...
class TrendTraderConfig:
    """
    🚀 КОНФИГУРАЦИЯ V15.2 - МАСШТАБИРОВАНИЕ ПРИБЫЛИ (УВЕЛИЧЕНИЕ РИСКА)
    ✅ КЛЮЧЕВЫЕ ИЗМЕНЕНИЯ:
       - ORDER_SIZE_RATIO: Увеличен с 2% до 4% для масштабирования результатов
         успешной стратегии V15.1.
    """
...
def main():
    try:
        logger.info("="*20 + " ЗАПУСК СИСТЕМЫ V15.2 (Масштабирование прибыли) " + "="*20)
