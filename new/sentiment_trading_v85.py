...
logging.basicConfig(
    ...
    filename='trading_v13_11.log', # ✅ ИЗМЕНЕНИЕ: Новый файл лога
    filemode='w'
)
...
class TrendTraderConfig:
    """
    🚀 КОНФИГУРАЦИЯ V13.11 - ОПТИМИЗАЦИЯ ОБУЧЕНИЯ С EARLY STOPPING
    ✅ КЛЮЧЕВЫЕ ИЗМЕНЕНИЯ:
...
class EarlyStoppingCallback(BaseCallback):
    ...
    def _evaluate_performance(self) -> float:
        ...
        while not done:
            ...
            obs, _, terminated, truncated, _ = eval_vec_env.step(action)
...
def main():
    try:
        logger.info("="*20 + " ЗАПУСК СИСТЕМЫ V13.11 (Early Stopping) " + "="*20)
